...
public class ConnectionServiceImpl implements ConnectionService {
    ...
    public void update(String userId, Connection<?> userConn) {
        ...
        for(FacebookProfile facebookUserProfile : profiles) {
            UserAccountEntity userAccountEntity = mongoTemplate.findOne(query(Criteria.where("UID").is(facebookUserProfile.getId())), UserAccountEntity.class);
    ...
    private void saveUserProfile(FacebookProfile facebookUserProfile, UserAccountEntity userAccount) {
        UserProfileEntity userProfile = mongoTemplate.findOne(query(Criteria.where("UID").is(facebookUserProfile.getId())), UserProfileEntity.class);
        if(userProfile == null) {
